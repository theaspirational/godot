...
globle void CheckSyntaxFunction(
  ...
  DATA_OBJECT *returnValue)
  {
   ...
   /*========================================*/
   /* The argument should be of type STRING_CLIPS. */
   /*========================================*/

   if (EnvArgTypeCheck(theEnv,"check-syntax",1,STRING_CLIPS,&theArg) == FALSE)
     { return; }
...
static void SetErrorCaptureValues(
  ...
  DATA_OBJECT_PTR returnValue)
  {
   ...
   if (ParseFunctionData(theEnv)->ErrorString != NULL)
     {
      SetMFType(theMultifield,1,STRING_CLIPS);
   ...
   if (ParseFunctionData(theEnv)->WarningString != NULL)
     {
      SetMFType(theMultifield,2,STRING_CLIPS);

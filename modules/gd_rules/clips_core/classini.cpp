...
globle void ObjectsRunTimeInitialize(
  ...
  unsigned mid)
  {
   ...
   DefclassData(theEnv)->PrimitiveClassMap[FLOAT_CLIPS] =
   ...
   DefclassData(theEnv)->PrimitiveClassMap[STRING_CLIPS] =
...
globle void CreateSystemClasses(
  void *theEnv)
  {
   ...
   DefclassData(theEnv)->PrimitiveClassMap[FLOAT_CLIPS] = AddSystemClass(theEnv,FLOAT_TYPE_NAME,number);
   ...
   DefclassData(theEnv)->PrimitiveClassMap[STRING_CLIPS] = AddSystemClass(theEnv,STRING_TYPE_NAME,lexeme);
   ...
   /* =======================================================================
      ...
      See CONSTANT.H
      ======================================================================= */
   AddConstructToModule((struct constructHeader *) DefclassData(theEnv)->PrimitiveClassMap[FLOAT_CLIPS]);
   ...
   AddConstructToModule((struct constructHeader *) DefclassData(theEnv)->PrimitiveClassMap[STRING_CLIPS]);

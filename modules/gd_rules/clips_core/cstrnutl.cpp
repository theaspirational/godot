...
globle int CompareNumbers(
  ...
  void *vptr2)
  {
   ...
   if ((type1 == FLOAT_CLIPS) && (type2 == FLOAT_CLIPS))
     {
   ...
   if ((type1 == INTEGER) && (type2 == FLOAT_CLIPS))
     {
   ...
   if ((type1 == FLOAT_CLIPS) && (type2 == INTEGER))
     {
...
globle CONSTRAINT_RECORD *ExpressionToConstraintRecord(
  ...
  struct expr *theExpression)
  {
   ...
   if (theExpression->type == FLOAT_CLIPS)
     {
   ...
   else if (theExpression->type == STRING_CLIPS)
     {
...
/*   record with allowed types INTEGER and FLOAT_CLIPS.      */
/*******************************************************/

...
static void UpdateRestrictionFlags(
  CONSTRAINT_RECORD *rv)
  {
   ...
   if ((rv->stringRestriction)  && (rv->stringsAllowed))
     { rv->stringsAllowed = FindItemInExpression(STRING_CLIPS,NULL,FALSE,rv->restrictionList); }

   if ((rv->floatRestriction) && (rv->floatsAllowed))
     { rv->floatsAllowed = FindItemInExpression(FLOAT_CLIPS,NULL,FALSE,rv->restrictionList); }
...
static int RestrictionOnType(
  ...
  CONSTRAINT_RECORD *theConstraint)
  {
   ...
   if ((theConstraint->anyRestriction) ||
       ...
       (theConstraint->stringRestriction && (theType == STRING_CLIPS)) ||
       (theConstraint->floatRestriction && (theType == FLOAT_CLIPS)) ||
